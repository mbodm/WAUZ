...
- WAUZ will not touch any other files or folders in Destination-Folder, besides the ones coming from the zip files. :warning: Since release version 1.0.3 this is no longer true! :warning:
